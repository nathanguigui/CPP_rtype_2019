...
RType::LittleBrown::LittleBrown(sf::RenderWindow *app): step(0), _app(app) {
...
RType::LittleBrown::~LittleBrown() {

}

void RType::LittleBrown::run() {
    if (this->step == 0) {
...
void RType::LittleBrown::setPosition(sf::Vector2f pos) {
    _sprite->setPosition(pos);
}

void RType::LittleBrown::destroy() {

}

void RType::LittleBrown::draw() {
    this->run();
}
