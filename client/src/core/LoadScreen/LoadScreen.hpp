...
#ifndef CPP_RTYPE_2019_LOADSCREEN_HPP
#define CPP_RTYPE_2019_LOADSCREEN_HPP
...
namespace RType {
    ...
    class LoadScreen: public CoreObject {
    public:
        LoadScreen(sf::RenderWindow *app, WindowState *state);
        void run();
        ~LoadScreen();
